...
<?php
	...
	$information_rejected		= $_POST['information_rejected'];
	...
	if (empty(	$_POST['information_rejected'])) {
	?>
	...
	$input	= "insert into ro_approve (ro_id_approve, ro_id, amount_approved, information_rejected, user_update, update_date, update_time, update_number) values ('$ro_id_approve', '$ro_id', '$amount_approved', '$information_rejected', '$user_update', '$update_date', '$update_time', '$update_number')";
	
	$query_input =mysql_query($input);

	$update=" update ro_draft set ro_status = '3'
				WHERE ro_id ='$ro_id'";
