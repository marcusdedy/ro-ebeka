<?php 
    ...
    if(!isset($_SESSION['username']) && $access!="Finance"){
		?>
...
<body>
	<table width="1250" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
	        ...
	        <td width="900" align="right" bgcolor="#FFFFFF"><img src="images/header-fin.jpg" width="450" height="112"></td>
		</tr>
	</table>
	<table width="1250" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
	...
	<table width="1250" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		<th width="944" height="22" align="center" valign="middle" bgcolor="#FFFFFF">
	    	<ul id="MenuBar1" class="MenuBarHorizontal">
	        	<li><a href="home-fin.php?page=home-fin&username=<?=$_SESSION['username']?>" title="Home">Home</a></li>
					...
					<tr>
						<td width="938" align="center" valign="middle">
							<?php
								...
								switch ($page)
								{
									case 'form-view-konfirmasi-fin' : include "form-view-konfirmasi-fin.php"; break;
									case 'main' :
									default : include 'about-login-fin.php';	
								}
							?>
						</td>	
					</tr>
