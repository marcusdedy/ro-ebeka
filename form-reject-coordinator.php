...
?>
	...
	?>
<form action="proses-reject.php" method="POST" name="form_reject" >
	<table width="1100" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr height="26">
				<td width="4%">&nbsp;</td>
				<td width="12%">&nbsp;</td>
				<td width="84%"><font color="orange" size="5"><b>Reason Rejected</b></font></td>
			</tr>
		<tr height="36">
			<td height="27">&nbsp;</td>
			<td>ID</td>
      ...
      <tr height="36">
		  <td height="35">&nbsp;</td>
		  <td>Nominal</td>
		  <td><input name="amount_approved" type="text" value="<?=$nominal_request?>" size="20" readonly /></td>
	  </tr>
            <tr height="36">
		  <td height="29">&nbsp;</td>
		  <td>Reason</td>
		  <td><textarea name="information_rejected" cols="30" required="required"></textarea></td>
	  </tr>
		<tr height="36">
			<td>&nbsp;</td>
			<td>User</td>
