...
<center>
  <font color="orange" size="3"><b>View Data Trouble Ticket</b></font>
</center>
...
<form action="home-helpdesk.php?page=form-view-data-helpdesk&username=<?=$_SESSION['username']?>" method="post" name="postform">
      ...
      <td bgcolor="#EEF2F7">
        <div align="center">
          <a href="javascript:void(0);"
            onclick="window.open('form-edit-do-dtl.php?ddt_reffid=<?php echo $ddt_reffid; ?>','nama_window_pop_up','height = 560, width = 1300, resizable = 0')" > <img src="images/icon/edit-2.png" title = "Edit"/></a>
            &nbsp&nbsp
          <a href="home-helpdesk.php?page=proses-delete-draft-tt&ro_id=<?=$ro_id?>" onclick="return confirm('Anda akan Menghapus Data Ticket ID = <?=$ticket_id?>')"> <img src="images/icon/Remove_24x24.png" title = "Delete"/></a>
        </div>
      </td>
